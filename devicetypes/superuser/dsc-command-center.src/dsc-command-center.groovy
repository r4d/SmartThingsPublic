	...
	tiles(scale: 2) {
		multiAttributeTile(name:"status", type: "generic", width: 6, height: 4){
     	   tileAttribute ("device.switch", key: "PRIMARY_CONTROL") {
           		attributeState "on", label:'ON', icon:"st.security.alarm.on", backgroundColor:"#008CC1"
                attributeState "off", label:'OFF', icon:"st.security.alarm.off", backgroundColor:"#008CC1"
		...
		standardTile("stayarm", "capability.momentary", width: 2, height: 2, title: "Armed Stay", required: true, multiple: false){
       	...
       	standardTile("off", "capability.momentary", width: 2, height: 2, title: "Off", required: true, multiple: false){
			state "off", label: 'Off', action:"switch.off", icon: "st.Home.home4", backgroundColor: "#79b821"
		}
		standardTile("on", "capability.momentary", width: 2, height: 2, title: "On", required: true, multiple: false){
			state "on", label: 'On', action: "switch.on", icon: "st.Home.home4", backgroundColor: "#800000"
       	}
